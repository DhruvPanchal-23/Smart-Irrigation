...
- [x] Added responsive temperature/humidity, rain, wind, recommendation, and condition charts using Recharts.
...
- [x] Add farm selection and previous/play/pause/next simulation controls.
- [x] Add 1, 5, and 10 second playback speeds plus manual mode.
